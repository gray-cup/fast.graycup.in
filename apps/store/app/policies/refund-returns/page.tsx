      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-10 text-gray-700">
          <section>
            ...
            <p className="leading-relaxed">Orders can be cancelled within 12 hours of placing them by contacting us at <a href="mailto:arjun@graycup.in" className="text-amber-600 hover:underline cursor-pointer">arjun@graycup.in</a> or calling <a href="tel:+918527914317" className="text-amber-600 hover:underline cursor-pointer">+91 85279 14317</a>. Once the order has been dispatched, cancellation is not possible.</p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">If the tea inside your package is damaged on arrival, contact us within 48 hours of delivery with a photo and your order details. Email us at <a href="mailto:arjun@graycup.in" className="text-amber-600 hover:underline cursor-pointer">arjun@graycup.in</a> or call <a href="tel:+918527914317" className="text-amber-600 hover:underline cursor-pointer">+91 85279 14317</a> and we will do our best to assist you.</p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Email: <a href="mailto:arjun@graycup.in" className="text-amber-600 hover:underline cursor-pointer">arjun@graycup.in</a><br />
              Phone: <a href="tel:+918527914317" className="text-amber-600 hover:underline cursor-pointer">+91 85279 14317</a><br />
